...
const Dropdown = ({ options, label, value, onChange }) => {
  return (
    <div className="w-full">
      <label className="capitalize block text-[#666666] text-[16px] font-bold mb-1">
        {label}
      </label>
      <div className="relative">
        ...
        >
          <option className='text-[14px] font-normal text-[#767F8C]' value="" disabled>Select the job</option>
          {options.map((option) => (
